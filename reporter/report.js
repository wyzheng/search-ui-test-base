...
var MyCustomReporter = /** @class */ (function () {
    ...
    MyCustomReporter.prototype.onRunComplete = function (contexts, originalResults) {
        return __awaiter(this, void 0, void 0, function () {
            var results, errorInfos, paths, i, j, j, caseId, pref, index, k, caseName, fileName;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        results = (0, helper_1.deepClone)(originalResults);
                        return [4 /*yield*/, (0, helper_1.readErrorInfos)()];
                    case 1:
                        errorInfos = _a.sent();
                        paths = Object.keys(errorInfos);
                        // 更新测试结果
                        ...
                        fileName = "".concat(Date.now()).concat(Math.random());
