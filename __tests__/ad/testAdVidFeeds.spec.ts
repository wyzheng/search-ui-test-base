...
describe("testAdVidFeeds", () => {
  ...
  //@description:q=wxadtestVidFeeds，验证混排结果页品专广告是否召回
  ...
  //@description:点击广告头部，验证是否正确跳转到视频号动态落地页
  ...
  //@description:验证"进入视频号 "外链文案是否正确；点击外链，验证是否正确跳转到视频号动态落地页
  ...
  //@description:点击广告名称，验证是否正确跳转到"WXAD测试号"视频号
  ...
  test("testAdVideoAccount", async () => {
    ...
    while(num != 0){
      try  {
        ...
        let path = basedir + './static/pic/ad_finder.png';
        const image =  await ele.screenshot({path: path});
  ...
  test("testAdVideoAccountFollowed", async () => {
    await addMsg({
      context: undefined,
  ...
  //@description:验证广告小程序账号信息展示正确；点击账号，验证是否正确跳转到"苏宁拼购"小程序
  ...
  //@description:点击热门活动1，验证是否正确跳转到"唯品会特卖"小程序
  ...
  //@description:点击热门活动2，验证是否正确跳转到"苏宁拼购"小程序
  ...
  //@description:点击热门活动3，验证是否正确跳转到广告原生页
  ...
  //@description:点击热门活动3左侧菜单，验证是否正确跳转到"唯品会特卖"小程序
  ...
  //@description:点击热门活动3右侧菜单，验证是否正确跳转到百度首页
  ...
  //@description:点击热门活动4，验证是否正确跳转到"鹅房通"小程序
  test("testAdHotActvity4", async () => {
    await addMsg({
      context: undefined,
  ...
  //@description:点击热门活动4左侧菜单，验证是否正确跳转到广告原生页
  ...
  // @description:点击热门活动4右侧菜单，验证是否正确跳转到百度首页
